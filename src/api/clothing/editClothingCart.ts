...
type editClothingCartResponse =
 | 401
 | 404
 | 500
 | 200
 | 'quantidade excede o stoque'
 | 'stock é zero'
 | 'quantidade é menor que 0';

export default async function EditClothingCart(
 cookie: string,
 params: params,
): Promise<editClothingCartResponse> {
