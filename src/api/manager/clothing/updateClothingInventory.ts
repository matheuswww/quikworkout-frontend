...
export default async function UpdateClothingInventory(cookie: string, params: updateClothingInventoryParams):Promise<updateClothingInventory> {
  const url = api+pathManager+managerClothing+"/"+"updateClothingInventory"
