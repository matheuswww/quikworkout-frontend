...
export default function middleware(request: NextRequest) {
 ...
 if (url.pathname == '/auth/entrar' || url.pathname == '/auth/cadastrar') {
 ...
 if (
  url.pathname == '/manager-quikworkout/criar-roupa' ||
  url.pathname == '/manager-quikworkout' ||
  url.pathname == '/manager-quikworkout/cancelar-pedido' ||
  url.pathname == '/manager-quikworkout/roupas'
 ) {
...
function CheckAdminProfileExist(request: NextRequest) {
 ...
 return NextResponse.redirect(
  request.nextUrl.origin + '/manager-quikworkout/auth',
 );
}
...
export const config = {
 matcher: [
  '/auth/criar-dois-fatores',
  '/auth/entrar',
  '/auth/cadastrar',
  '/auth/validar-codigo-dois-fatores',
  '/auth/resetar-senha',
  '/usuario/minha-bolsa',
  '/finalizar-compra',
  '/usuario/meus-pedidos',
  '/usuario/minha-conta',
