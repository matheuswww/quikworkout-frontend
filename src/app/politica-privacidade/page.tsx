      ...
      <main className={styles.main}>
        <section>
            <p>
              ...
              Ao prosseguir com o cadastro ou login, você concorda com o tratamento dos seus dados pessoais (nome, e-mail e senha) conforme disposto na Lei Geral de Proteção de Dados (Lei nº 13.709/2018 - LGPD).<br/><br/>

              <strong className={styles.strong}>Finalidade do Tratamento:</strong><br/>
              Utilizamos as informações fornecidas (nome, e-mail e senha) exclusivamente para a autenticação e acesso seguro à sua conta.<br/>
