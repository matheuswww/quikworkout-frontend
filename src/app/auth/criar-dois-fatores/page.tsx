...
export const metadata: Metadata = {
 ...
 keywords:
  'criar dois fatores, quikworkout, criar dois fatores quikworkout, email, senha, autenticação dois fatores email, autenticação dois fatores senha',
};
