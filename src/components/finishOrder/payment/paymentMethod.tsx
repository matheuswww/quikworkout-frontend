  ...
  <>
   ...
   {paymentType == 'boleto' && (
    <Boleto
     ...
     setBoleto={setBoleto}
     setPaymentType={setPaymentType}
     showBoleto={showPayment}
    />
   )}
   <div
    className={`${styles.container} ${(paymentType == 'card' || paymentType == 'credit_card' || paymentType == 'debit_card' || paymentType == 'pix' || paymentType == 'boleto' || !showPayment) && styles.displayNone}`}
   >
    <button
