...
export default function Menu(props:props) {
  ...
  const [page, setPage] = useState<"home" | "my-bag" | "my-order" | "my-account" | null>(null)
        ...
        <nav tabIndex={0} className={`${styles.content} ${menu && styles.active}`} ref={menuRef} arial-aria-label="menu" >
          {
            ...
            <>
              <Link href="/" className={`${page == "home" && styles.currentPage}`}><Img alt="icone de uma casa" src="/img/home.png" width={22} height={20} />Home</Link>
              <Link href="/usuario/minha-bolsa" className={`${page == "my-bag" && styles.currentPage}`}><Img alt="icone de uma bolsa" src="/img/shop.png" width={22} height={21} className={styles.bag} style={{marginLeft: "5px",marginRight: "6px",top:"3px"}} />Minha bolsa</Link>
              <Link href="/usuario/meus-pedidos" className={`${page == "my-order" && styles.currentPage}`}><Img alt="icone de pedidos" src="/img/myorder.png" width={22} height={22} className={styles.bag} style={{marginLeft: "5px"}} />Meus pedidos</Link>
              <Link href="/usuario/minha-conta" className={`${page == "my-account" && styles.currentPage}`}><Img alt="icone de minha conta" src="/img/account.png" width={24} height={24} className={styles.bag} style={{marginLeft: "4px",marginRight: "3px"}} />Minha conta</Link>
            ...
            : <>
            <Link href="/auth/entrar"><Img alt="icone de entrar" src="/img/account.png" width={24} height={24} className={styles.bag} style={{marginLeft: "4px",marginRight: "3px"}} />Entrar</Link>
            <Link href="/auth/cadastrar"><Img alt="icone de cadastrar" src="/img/cadastrar.png" width={24} height={24} className={styles.bag} style={{marginLeft: "4px",marginRight: "3px"}} />Cadastrar</Link>
            </>
          }
        </nav>
