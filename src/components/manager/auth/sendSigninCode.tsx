...
import { ValidateEmail } from "@/funcs/validateEmailAndPhoneNumber"
...
const schema = z.object({
  email: z.string(),
  password: z.string().min(4 ,"senha precisa ter pelo menos 8 caracteres").max(72, "A senha deve ter no maxímo de 72 caracteres"),
}).refine((fields) => {
