...
export default function Menu(props: props) {
 ...
 const [page, setPage] = useState<
  'home' | 'criar-roupa' | 'roupas' | 'cancelar-pedido' | null
 >(null);
 ...
 return (
  <header>
   <div className={styles.container} ref={containerRef}>
    <Link href="/manager-quikworkout" className={styles.linkLogo}>
     <Logo
      src="/img/logo.png"
    ...
    >
     {props.cookieName && props.cookieVal ? (
      <>
       <Link
        href="/manager-quikworkout"
        className={`${page == 'home' && styles.currentPage}`}
       >
        <Img
       ...
       <Link
        href="/manager-quikworkout/roupas"
        className={`${page == 'roupas' && styles.currentPage}`}
       >
        <Img
       ...
       <Link
        href="/manager-quikworkout/criar-roupa"
        className={`${page == 'criar-roupa' && styles.currentPage}`}
       >
        <Img
         alt="icone de adiconar"
         src="/img/add.png"
         width={22}
         height={22}
         className={styles.bag}
       ...
       <Link
        href="/manager-quikworkout/cancelar-pedido"
        className={`${page == 'cancelar-pedido' && styles.currentPage}`}
       >
        <Img
         alt="icone de pedido"
         src="/img/myorder.png"
      ...
      <>
       <Link href="/manager-quikworkout/auth">
        <Img
         alt="icone de entrar"
         src="/img/account.png"
         width={24}
