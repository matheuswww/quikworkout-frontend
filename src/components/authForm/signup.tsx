...
const schema = z
 .object({
  ...
  name: z
   .string()
   .min(2, 'nome precisa ter pelo menos de 2 caracteres')
    ...
    <section className={styles.section}>
     ...
     >
      ...
      {errors.email?.message ? (
       ...
       res == 409 && (
        <p className={styles.error}>Este email já esta sendo utilizado</p>
       )
      )}
      ...
      <button
       ...
       type="submit"
      >
       {load ? 'Cadastrando, aguarde' : 'Cadastrar'}
      </button>
     </form>
    </section>
   </main>
