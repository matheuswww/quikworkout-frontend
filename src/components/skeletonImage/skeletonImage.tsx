...
interface skeletonImageProps extends Omit<React.DetailedHTMLProps<React.ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>, "height" | "width" | "loading" | "ref" | "alt" | "src" | "srcSet"> {
...
const SkeletonImage = React.forwardRef<HTMLImageElement | null, skeletonImageProps>((props, ref) => {
