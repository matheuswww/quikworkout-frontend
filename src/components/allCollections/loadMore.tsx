...
import GetAllClothing, { responseGetAllClothing } from "@/api/clothing/getAllClothing"
...
export default function LoadMore({cursor}:props) {
  ...
  return (
    <>
    {data && (data.status != 400 && data.status != 500) && data.clothing && data.clothing.map((clothing, index) => {
