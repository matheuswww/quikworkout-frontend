  ...
  inventory.map((i) => {
   ...
   if (i.cor == color) {
    if (i['p'] != 0) {
     items.push(
      <label
       className={`${styles.label} ${size == 'p' ? styles.selected : ''}`}
       key={'p'}
      >
       <input
        type="radio"
    ...
    if (i['m'] != 0) {
     items.push(
      <label
       className={`${styles.label} ${size == 'm' ? styles.selected : ''}`}
       key={'m'}
      >
       <input
        type="radio"
    ...
    if (i['g'] != 0) {
     items.push(
      <label
       className={`${styles.label} ${size == 'g' ? styles.selected : ''}`}
       key={'g'}
      >
       <input
        type="radio"
    ...
    if (i['gg'] != 0) {
     items.push(
      <label
       className={`${styles.label} ${size == 'gg' ? styles.selected : ''}`}
       key={'gg'}
      >
       <input
        type="radio"
