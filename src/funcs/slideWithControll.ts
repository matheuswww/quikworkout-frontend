...
export function slideWithControl(
  ...
  window.addEventListener("resize", () => {
    itemWidth = slide.children[0] instanceof HTMLElement ? slide.children[0].offsetWidth : 0
  ...
  const createSlideIndex = function() {
    if (slide.children.length >= 2) {
      ...
      index.firstChild instanceof HTMLElement && index.firstChild.classList.add(activeIndexClass)
