export default function handleModalColorClick(buttonToOpenModalRef:React.MutableRefObject<HTMLButtonElement | null>, modalRef:React.MutableRefObject<HTMLDivElement | null>, active: string, callbackOnEnter?: Function, callbackOnOut?: Function) {
